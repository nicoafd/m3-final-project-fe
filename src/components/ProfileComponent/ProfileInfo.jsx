                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                      ...
                      <div class="mt-3">
                        <h4>{username}</h4>
                        <p class="text-secondary mb-1">TradeHub User</p>
                ...
                <div class="row gutters-sm">
                    ...
                    <div class="card h-100">
                      <div class="card-body">
                        <h6 class="d-flex align-items-center mb-3">
                          <i class="material-icons text-info mr-2">Products</i>
                          All your Products
                        </h6>
                        {/* HERE GOES A LIST OF THE PRODUCTS!*/}
                        <div>
                          <Product />
                        </div>
                      </div>
                  ...
                  <div class="col-sm-12 mb-3">
                    <div class="card h-100">
                      <div class="card-body">
                        <h6 class="d-flex align-items-center mb-3">
                          <i class="material-icons text-info mr-2">Threads</i>
                          All your Threads
                        </h6>
                        <Thread />
                      </div>
